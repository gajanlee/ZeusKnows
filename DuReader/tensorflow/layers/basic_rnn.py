...
def normalize(inputs, 
    ...
    with tf.variable_scope('ln', reuse=reuse):
...
def rnn(rnn_type, inputs, length, hidden_size, layer_num=2, dropout_keep_prob=None, concat=True):
    """
...
def get_cell(rnn_type, hidden_size, layer_num=2, dropout_keep_prob=None):
    """
    Gets the RNN Cell
    Args:
